...
<head>
    <meta charset="UTF-8">
    <title><?php echo $industryName ?>行业热度情况</title>
...
<div class="container wk-container">
    <section class="wk-time-hot">
        ...
        <div class="col-md-4 right-infos">
            ...
            <p><?php echo $industryName ?>今日最热度</p>
            <hr>
                    ...
                    <div role="tabpanel" class="tab-pane active" id="industry-view">
                        <div class="col-md-5 left">
                            <p class="wk-hot-sub-title">查看热度排行&nbsp;
                                ...
                                <a href="hotrank.php?key=1,2,2,<?php echo $industryName ?>" class="wk-view-more" target='_blank'>更多&nbsp;<i class='fa fa-angle-double-right'></i></a>
                            </p>
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="industry-search">
                        <div class="col-md-5 left">
                            <p class="wk-hot-sub-title">搜索热度排行&nbsp;
                                <i class="fa fa-question-circle-o" data-toggle="popover" data-content="截至当前产生的总热度量的排行"></i>
                                <a href="hotrank.php?key=2,2,2,<?php echo $industryName ?>" class="wk-view-more" target='_blank'>更多&nbsp;<i class='fa fa-angle-double-right'></i></a>
                            </p>
                            <table class="table table-hover table-condensed table-striped wk-hot-table">
                                <thead>
                                <tr>
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="industry-follow">
                        <div class="col-md-5 left">
                            <p class="wk-hot-sub-title">关注热度排行&nbsp;
                                <i class="fa fa-question-circle-o" data-toggle="popover" data-content="截至当前产生的总热度量的排行"></i>
                                <a href="hotrank.php?key=3,2,2,<?php echo $industryName ?>" class="wk-view-more" target='_blank'>更多&nbsp;<i class='fa fa-angle-double-right'></i></a>
                            </p>
                            <table class="table table-hover table-condensed table-striped wk-hot-table">
                                <thead>
                                <tr>
...
<script src="static/js/page/industry.min.js"></script>
</body>
</html>