...
<div class="container wk-container wk-company" data-html-type="profile">
    <section class="wk-release">
        ...
        <ul class="nav nav-tabs release_ul" style="padding-top: 11px;border:0px">
            <li class="active" data-userid="<?php echo $_SESSION['user_id'] ?>"><a href="#release_all_info" data-toggle="tab">全部</a></li>
        ...
        <div class="tab-content">
            <div class="all_content tab-pane active" id="release_all_info">
                <div class="row">
                    <div class="col-md-2">
                        <ul class="release_time">
                            <li class="cont_date fl">2016-08-16</li><div class="cont_date_line fl"><div class="cont_date_circle"></div></div>
                            <!--具体的时间与对应消息用户头像--->
                            <li class="fl">15:10</li>
                            <div class="time_line fl">
                                <div class="time_circle"></div>
                                <div class="release_usericon"></div>
                            </div>
                    ...
                    <div class="col-md-10">
                        ...
                        <div class="release_content">
                            <div class="content_user">pufa-浦发银行 <span class="release_end">已结束</span></div>
                            <div class="content_main">
                                <div class="content_main_text">
                                    投资于不动产，我仅限。。
                                </div>
            ...
            <div class="own_content tab-pane" id="release_own_info">
                <div class="row">
                    ...
                    <div class="col-md-10">
                        <!--一条消息--->
                        <div class="release_content">
                            <div class="content_user">pufa-浦发银行</div>
                            <div class="content_main">
                                <div class="content_main_text">
                                    投资于不动产，我仅限。。
                                </div>
...
<script src="../static/plugins/webim/webim.js"></script>
</body>
</html>