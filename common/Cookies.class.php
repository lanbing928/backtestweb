...
class Cookies
{
     ...
     * @var string
     */
    private $_securekey = 'fae16c6b-d314-4c54-89aa-ba2c0a933f1e';
    /**
     * 默认过期时间
     * @var int
     */
     ...
     * @param String $securekey cookie 安全秘钥
     */
     ...
     * @param mixed $value cookie 值 可以是字符串,数组,对象等
     * @param int $expire 过期时间
     */
     ...
     * @internal param String $str 原文或密文
     */
