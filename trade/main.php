...
<head>
    ...
    <link rel="stylesheet" href="<?php echo UtilityTools::AutoVersion('/static/css/index.min.css')?>">
</head>
<body>
...
<script src="<?php echo UtilityTools::AutoVersion('/static/js/all.min.js')?>"></script>
<script src="<?php echo UtilityTools::AutoVersion('/static/js/page/hotrank.min.js')?>"></script>
</body>
</html>