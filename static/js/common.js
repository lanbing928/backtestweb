        ...
        common.getRelatedInfo(arrData, function () {
            ...
            if (resultData.news.length > 0) {
                ...
                if (arrData.start_id == 0) {
                    $(".loadingmask").remove();
                    newsHtml.push("<div class=\"wk-news-no\"><img src=\"http://static.iwookong.com/imgs/i/nonews.png\"><span>暂无相关新闻资讯</span></div>");
    ...
    getSelfMedia: function (arrData) {
        ...
        common.getRelatedInfo(arrData, function () {
            ...
            if (resultData.me_media.length > 0) {
                ...
                if (arrData.start_id == 0) {
                    $(".loadingmask").remove();
                    mediaHtml.push("<div class=\"wk-news-no\"><img src=\"http://static.iwookong.com/imgs/i/nonews.png\"><span>暂无相关达人观点</span></div>");
    ...
    getFastNews: function (arrData) {
        ...
        common.getRelatedInfo(arrData, function () {
            ...
            if (resultData.fast_info.length > 0) {
                ...
                if (arrData.start_id == 0) {
                    $(".loadingmask").remove();
                    fastHtml.push("<div class=\"wk-news-no\"><img src=\"http://static.iwookong.com/imgs/i/nonews.png\"><span>暂无相关快讯</span></div>");
    ...
    getTreemap: function (wk_treemap_data) {
        for (var x in wk_treemap_data) {
            if (Utility.timeRange("09:15", "09:25")) {
                $("#" + wk_treemap_data[x].key).html("<div class=\"wk-hotmap-no\"><img src=\"http://static.iwookong.com/imgs/i/nonews.png\"><span>自由竞价时间,暂无数据</span></div>");
            } else {
