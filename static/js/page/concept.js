...
(function ($, window, document) {
    ...
    function initLineChart() {
        common.getHyAndGnHot({"name": name, "query_type": 2, "hour_data": "concept"}, null, function (resultData) {
        ...
        common.getHyAndGnHot({"name": name, "query_type": 2, "minute_data": "minute_data"}, function () {
            ...
            if (resultData.status == 1) {
                if (resultData.visit) {
                    ...
                    _modalViewData = JSON.parse("[" + _modalViewData.sort(function (a, b) {
                            return a - b;
                        }).join(',') + "]");
                }
